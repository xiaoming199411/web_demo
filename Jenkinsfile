pipeline {
    ...
    stages {
        stage('pull code') {
            steps {
                checkout([$class: 'GitSCM', branches: [[name: '*/${branch}']], extensions: [], userRemoteConfigs: [[credentialsId: 'f007aea6-fb34-45bd-928d-178f6aa6d091', url: 'git@github.com:xiaoming199411/web_demo.git']]])
